...
class STGCN_Event(AbstractTrafficStateModel):
    ...
    def calculate_loss(self, batch):
        ...
        y_softmax = F.softmax(y_predicted, dim=1)
        loss = F.binary_cross_entropy(y_softmax, y_true)
        return loss
    ...
    def predict(self, batch):
        ...
        return F.softmax(y_preds, dim=1)
