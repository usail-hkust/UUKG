...
parser.add_argument(
    "--model", default="MME", choices=all_models, help="Knowledge Graph embedding model"
)
parser.add_argument(
...
parser.add_argument(
    "--max_epochs", default=500, type=int, help="Maximum number of epochs to train for"
)
parser.add_argument(
...
parser.add_argument(
    "--batch_size", default=7120, type=int, help="Batch size"
)
parser.add_argument(
